class Settings {
    ...
    static hideFireAspect = false;
    static hideVenomous = false;
    static hideThunderlord = false;
...
function toggle(modename, setting) {
    chat("Toggled: " + modename + " to " + setting);
}
...
const DamageType = { Fire: "fire", Venom: "venom", Thunder: "thunder", Noncrit: "noncrit", None: "none" };
...
function how2Use() {
    ...
    ChatLib.chat("§7     Toggle the specified option. All are off by default.");
